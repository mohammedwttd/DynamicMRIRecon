...
def main():
    ...
    models_config = [
        ...
        {
            'name': 'LightUNet',
            'checkpoint': 'summary/16/cartesian_1_4_0.08_0.0005_fixed_LightUNet_50/best_model.pt',
            'apply_sparsity': False,
        },
        {
            'name': 'Unet',
            'checkpoint': 'summary/16/cartesian_1_4_0.08_0.0005_fixed_Unet_50/best_model.pt',
            'apply_sparsity': False,
        },
    ]
